...
function LoginPage() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="hidden lg:block" style={{ background: "var(--gradient-brand)" }}>
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-sm">
          ...
          <Button variant="outline" className="mt-6 w-full gap-2" type="button" onClick={() => toast.info("Google login is design-ready — connect a provider to enable.")}>
